...
import type { PracticeSheet, PracticeQuestion } from '../types'
...
function Practice() {
  ...
  // Get store actions
  const { completePracticeSheet } = useAppStore()
    ...
    if (currentQuestionIndex < practiceQuestions.length - 1) {
      ...
      if (currentPracticeSheet) {
        try {
          ...
          // Call store to complete practice sheet
          await completePracticeSheet(currentPracticeSheet.id, newAnswers, score)
